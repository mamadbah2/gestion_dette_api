...
class Client
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(["client.api.index", "debt_request.api.index","client.create"])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(["client.api.index", "debt.api.index", "debt_request.api.index","client.create"])]
    ...
    #[Groups(["client.api.index","client.create"])]
    ...
    public function getBoutiq(): ?Boutiq
    {
        return $this->boutiq;
    }

    public function setBoutiq(?Boutiq $boutiq): static
    {
        $this->boutiq = $boutiq;
